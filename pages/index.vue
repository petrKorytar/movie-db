...
import TheHero from "~/components/TheHero.vue";
 export default {
    ...
    methods: {
      ...
      async getMovies(){
        const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=8f297756c11ba17f427a61dc53484f52&language=en-US&page=1')
      ...
      async searchMovies(){
        const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=8f297756c11ba17f427a61dc53484f52&language=en-US&page=1&query=${this.searchInput}`)
        const result = await data
        result.data.results.forEach(movie => {
